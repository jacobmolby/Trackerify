<template>
  <header class="py-3 flex-none bg-indigo-500">
    <div class="flex flex-shrink-0 justify-between items-center">
      <div class="pl-10 pr-4 flex items-center justify-between">
      ...
      <div class="flex items-center">
        ...
        <div class="px-4 py-3 flex items-center border-l border-indigo-400">
          <svg class="h-4 w-4 fill-current text-gray-200" viewBox="0 0 20 20">
            <path
        ...
        <div class="px-4 flex items-center border-l border-indigo-400">
