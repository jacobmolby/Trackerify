<template>
  <header class="h-16 bg-indigo-500">
    <div class="flex flex-shrink-0 justify-between h-full">
      <div class="pl-10 pr-4 h-full flex items-center justify-between">
      ...
      <div class="h-full flex items-center">
        ...
        <div class="px-4 h-full flex items-center border-l border-indigo-400">
          <svg class="h-4 w-4 fill-current text-gray-200" viewBox="0 0 20 20">
            <path
        ...
        <div class="px-4 h-full flex items-center border-l border-indigo-400">
          <span class="text-white">M. Thompson</span>
          <img
