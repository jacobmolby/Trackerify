<template>
  <main class="p-10 text-gray-300">
    <header class="text-center font-bold">
      <div class="flex justify-center items-center w-full">
        <svg class="fill-current text-white inline-block h-24 w-24" viewBox="0 0 20 20">
          <path
        ...
        <h1 class="ml-4 text-white text-6xl">Trackerify</h1>
      </div>
