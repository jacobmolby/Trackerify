  ...
  <div class="h-screen flex overflow-hidden">
    ...
    >
      <div class="flex items-center justify-between">
        <div class="font-extrabold text-xl text-orange-500 border-b border-orange-500">TRACKERIFY</div>
            ...
            <div class="py-2 sm:flex items-center justify-between">
              <div class="flex justify-between sm:justify-start">
                <div class="flex items-baseline">
                  <h1 class="text-2xl font-semibold text-gray-900 leading-tight">{{board.title}}</h1>
...
export default {
  ...
  data() {
    return {
      boardId: '5df2036f33c8181fc85cb3cb',
